...
class Asteroids:
    ...
    def __init__(self, mainWindow):
        ...
        # Particles
        self.boom = Particles.ParticleSpritesheet(resource_path("Assets/spritesheets/explosion.png"), columns=4, rows=4,
                                                  totalFrames=16, fps=50)
        self.trail = Particles.ParticleSpritesheet(resource_path("Assets/spritesheets/trailing_fire.png"), columns=3, rows=3,
